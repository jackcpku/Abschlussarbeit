...
#define __load_no_speculate1(__ptr, __low, __high, __failval,                                                           \
    ...
    (__extension__({                                                                                                    \
        ...
        __typeof__(*(__ptr)) __fv = (__typeof__(*(__ptr)))(unsigned long long)(__failval);                              \
        ...
        if (__builtin_constant_p((unsigned long long)__high) && __high == ((void *)0))                                  \
        {                                                                                                               \
            __asm__ volatile(                                                                                           \
                "cmp\t%[__c], %[__l]\n\t"                                                                               \
                "bcc\t.ns%=\n\t"                                                                                        \
...
#define __load_no_speculate1(__ptr, __low, __high, __failval,                                                           \
    ...
    (__extension__({                                                                                                    \
        __typeof__(0 + *(__ptr)) __nln_val;                                                                             \
        __typeof__(*(__ptr)) __fv = (__typeof__(*(__ptr)))(unsigned long)(__failval);                                   \
        /* If __high is explicitly NULL, we must not emit the                                                           \
           upper-bound comparison.  We need to cast __high to an                                                        \
           unsigned long before handing it to __builtin_constant_p to                                                   \
           ensure that clang/llvm correctly detects NULL as a constant if it                                            \
           is defined as (void*) 0.  */                                                                                 \
        if (__builtin_constant_p((unsigned long)__high) && __high == ((void *)0))                                       \
        {                                                                                                               \
            __asm__ volatile(                                                                                           \
                ".syntax unified\n\t"                                                                                   \
                "cmp\t%[__c], %[__l]\n\t"                                                                               \
